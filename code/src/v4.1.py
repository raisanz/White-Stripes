...
def end() -> None: 
    brain.program_stop()
# code for checking object distance
def check_distance() -> None:
    brain.screen.clear_row(1)
    brain.screen.set_cursor(1, 1)
    brain.screen.set_font(FontType.MONO12)
    if distance_sensor.object_distance(MM) < 700:
        brain_print("Object is " + str(distance_sensor.object_distance(MM)) + " mm away")
    else:
        brain_print("No object detected")
# main code file
def main() -> None:
        ...
        while True:
            ...
            while True:
                ...
                if working:
                    ...
                    led2.set_color(Color(247, 181, 0))
                    nonlocal working
                    if not working:
                        break
                    else:
