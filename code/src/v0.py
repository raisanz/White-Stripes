...
def sort_by_color():
    ...
    if distance_sensor.object_distance(INCHES) < 7:
        ...
        led.off()
        return None
def item_count(color, r = 0, g = 0, b = 0):
    if color == "Red":
        r += 1
        return r
    elif color == "Blue":
...
if sorting_mode == 1:
    ...
    while True:
        ...
        if color == "Red":
            ...
            drop_off()
            red = item_count(color, red, green, blue)
            ...
            drivetrain.drive_for(FORWARD, 10, INCHES)
            drop_off()
            blue = item_count(color, red, green, blue)
            drivetrain.drive_for(REVERSE, 10, INCHES)
            drivetrain.turn_for(RIGHT, 90, DEGREES)
        elif color == "Green":
            drivetrain.drive_for(REVERSE, 10, INCHES)
            ...
            drivetrain.drive_for(FORWARD, 10, INCHES)
            drop_off()
            green = item_count(color, red, green, blue)
            drivetrain.drive_for(REVERSE, 10, INCHES)
            drivetrain.turn_for(LEFT, 90, DEGREES)
            drivetrain.drive_for(FORWARD, 10, INCHES)
        else:
            ...
            break
        screen_prep(2, False)
        brain_print("Red: " + str(red))
        screen_prep(3, False)
        brain_print("Blue: " + str(blue))
        screen_prep(4, False)
        brain_print("Green: " + str(green))
